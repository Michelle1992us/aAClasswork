...
=begin
- Show the name, continent, and population of every country that:
  - has a population less than 25mil
  - belongs to a continent where every country within the continent has a population < 25mil
=end